...
<div class="container">
    ...
    <form method="POST" action="">
        ...
        <div>
            ...
            <input title="companyname" type="text" name="name" placeholder="Company name" size="22" maxlength="30"
                autofocus id='companyname' required value="<?php echo $name; ?>">
        ...
        <div>
            ...
            <select class="w-100 p-2 selectSearch" id="country" name="country" placeholder="Company country"
        ...
        <div>
            ...
            <select class="w-100 p-2" id="companyrole" name="role" placeholder="Company role" maxlength="30"
