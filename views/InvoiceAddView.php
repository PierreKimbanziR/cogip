        ...
        <div class="form-group row">
            <div class="col-sm-12 col-md-4">
                ...
                <input type="text" id="invoiceNumber" name="invoiceNumber" class="form-control"
                    <?php if (!isset($invoice['invoiceNumber'])) {?>
                    value="COG<?=date('Y')?>-<?=htmlspecialchars($lastId)?>" <?php } else {
    ?> value="<?=htmlspecialchars($invoice['invoiceNumber'])?>" <?php }?>>
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <input type="number" id="amount" name="amount" class="form-control"
                    <?php if (isset($invoice['amount'])) {?> value="<?=htmlspecialchars($invoice['amount'])?>"
                    <?php }?>>
            </div>
            <div class="col-sm-12 col-md-4">
...
?>
    ...
    echo htmlspecialchars($invoice['description']);
        ...
        <div class="form-group">
            <input type="submit" class="btn btn-mdb-color waves-effect" <?php if (isset($invoice['invoiceNumber'])) {?>
                value="Modify the invoice" <?php } else {
