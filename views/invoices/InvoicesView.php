            ...
            <tbody>
                ...
                foreach ($invoicescomp as $invoice) :
                    ...
                    <tr id="<?= $invoice['id'] ?>" class="hoverable">
                        ...
                        <td class="text-center d-flex <?= ($_SESSION['level'] > 2) ? 'justify-content-around' : 'justify-content-center' ?>">
                            ...
                            <?php if (($_SESSION['level'] > 2)) : ?>
                                ...
                                <i class="fas fa-lg fa-trash-alt pointer toggleModal" data-itemid="<?= $invoice['id'] ?>" data-itemname="<?= $invoice['invoiceNumber'] ?>" data-item="invoices" data-toggle="modal" data-target="#deleteModal"></i>
                            <?php endif ?>
                        </td>
                    </tr>
                    ...
                    <tr id="<?= $invoice['id'] ?>" class="hoverable">
                        ...
                        <td class="text-center d-flex <?= ($_SESSION['level'] > 2) ? 'justify-content-around' : 'justify-content-center' ?>">
                            ...
                            <?php if (($_SESSION['level'] > 2)) : ?>
                                ...
                                <i class="fas fa-lg fa-trash-alt pointer toggleModal" data-itemid="<?= $invoice['id'] ?>" data-itemname="<?= $invoice['invoiceNumber'] ?>" data-item="invoices" data-toggle="modal" data-target="#deleteModal">
                                </i><?php endif ?>
                        </td>
                    </tr>
